...
summary: Ab ONTAP 9.4 können Sie die ONTAP CLI verwenden, um eine Beziehung zu erstellen, die SnapMirror verwendet, um Snapshot Kopien einer auf einer ONTAP Quelle erstellten LUN zurück zu einem Element Ziel zu replizieren. 
---
...
[role="lead"]
Ab ONTAP 9.4 können Sie die ONTAP CLI verwenden, um eine Beziehung zu erstellen, die SnapMirror verwendet, um Snapshot Kopien einer auf einer ONTAP Quelle erstellten LUN zurück zu einem Element Ziel zu replizieren. Möglicherweise verwenden Sie die LUN, um Daten von ONTAP zu Element Software zu migrieren.
